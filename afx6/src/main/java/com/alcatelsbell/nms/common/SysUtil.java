...
public class SysUtil {
     ...
     * @return
     */
    public static int getAlarmSeverity(int value){
    	switch(value)
        {
        case 0: // '\0'
            return SysConst.ALARM_SEVERITY_INTERMEDIATE;

        case 1: // '\001'
            return SysConst.ALARM_SEVERITY_CRITICAL;

        case 2: // '\002'
            return SysConst.ALARM_SEVERITY_MAJOR;

        case 3: // '\003'
            return SysConst.ALARM_SEVERITY_MINOR;

        case 4: // '\004'
            return SysConst.ALARM_SEVERITY_WARNING;

        case 5: // '\005'
            return SysConst.ALARM_SEVERITY_CLEAR;
        }
    	return SysConst.ALARM_SEVERITY_UNKNOWN_SEVERITY;
    }
     ...
     * @return
     */
    public static int getObjectType(int value){
        switch(value)
        {
        case 0: // '\0'
            return SysConst.ALARM_OBJECTTYPE_EMS;

        case 1: // '\001'
            return SysConst.ALARM_OBJECTTYPE_NE;

        case 2: // '\002'
            return SysConst.ALARM_OBJECTTYPE_SUBNETWORK;

        case 3: // '\003'
            return SysConst.ALARM_OBJECTTYPE_TOPOLOGICAL_LINK;

        case 4: // '\004'
            return SysConst.ALARM_OBJECTTYPE_SUBNETWORK_CONNECTION;

        case 5: // '\005'
            return SysConst.ALARM_OBJECTTYPE_PTP;

        case 6: // '\006'
            return SysConst.ALARM_OBJECTTYPE_CTP;

        case 7: // '\007'
            return SysConst.ALARM_OBJECTTYPE_CTC;

        case 8: // '\b'
            //return OT_EQUIPMENT_HOLDER;
        	return SysConst.ALARM_OBJECTTYPE_SLOT;

        case 9: // '\t'
            //return OT_EQUIPMENT;
        	return SysConst.ALARM_OBJECTTYPE_CARD;

        case 10: // '\n'
            return SysConst.ALARM_OBJECTTYPE_PROTECTION_GROUP;

        case 11: // '\013'
            return SysConst.ALARM_OBJECTTYPE_TRAFFIC_DESCRIPTOR;

        case 12: // '\f'
            return SysConst.ALARM_OBJECTTYPE_AID;

        case 13: // '\r'
        	return SysConst.ALARM_OBJECTTYPE_CROSS_CONNECT;

        case 14: // '\016'
        	return SysConst.ALARM_OBJECTTYPE_STATION;

        case 15: // '\017'
        	return SysConst.ALARM_OBJECTTYPE_LOGICAL_AREA;

        case 16: // '\020'
        	return SysConst.ALARM_OBJECTTYPE_AREA;

        case 17: // '\021'
        	return SysConst.ALARM_OBJECTTYPE_PM_TASK;
        }
    	return SysConst.ALARM_OBJECTTYPE_UNKNOWN;
    }
