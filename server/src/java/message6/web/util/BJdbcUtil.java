...
//    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class.forName("org.util.JDBC");
        String filePath = "cde.db";
   //     Connection connection = DriverManager.getConnection("jdbc:util:"+filePath);
        Connection connection = DriverManager.getConnection("jdbc:util::memory:");
        connection.setAutoCommit(false);
