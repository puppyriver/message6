...
@Table(name = "F_STATUS")
@Entity
public class Curralarm extends BObject {

    @Index(name = "STATUS_INDEX_IDENTIFIER")
	...
	private String alertgroup;	//位置属性   线路口   支路口
	...
	private String localpriobj;			//角色名
	private String localsecobj;			//角色id
	...
	@Index(name = "STATUS_INDEX_ALARMSTATUS")
    ...
    private Integer asb_AssociationFlag;//是否有相关联的告警
    private Integer asb_PossibleRC;     //1(是子告警),2(是父告警),3;即是父告警又是子告警
    private Integer asb_EnrichFlag = 0;
    private String std_devicePrefecture;    //设备地市
    private String std_deviceCounty;         //设备区县
    private String maintainer; 			//A/B角
    private String maintainercode;		//A/B角id
    private Integer maintainTime;		//设置预处理的时间
